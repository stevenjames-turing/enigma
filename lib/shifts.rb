class Shifts
  ...
  def valid_key?
    (key != "-00000") && (a_key[1] == b_key[0]) && (b_key[1] == c_key[0]) && (c_key[1] == d_key[0])
  end

  def get_valid_key
    possible_keys = (0...99999).to_a
    a1 = a_key.to_i; a2 = a1 + 27; a3 = a2 + 27; a4 = a3 + 27; a5 = a4 + 27
    b1 = b_key.to_i; b2 = b1 + 27; b3 = b2 + 27; b4 = b3 + 27; b5 = b4 + 27
    c1 = c_key.to_i; c2 = c1 + 27; c3 = c2 + 27; c4 = c3 + 27; c5 = c4 + 27
    d1 = d_key.to_i; d2 = d1 + 27; d3 = d2 + 27; d4 = d3 + 27; d5 = d4 + 27
    a_keys = [a1, a2, a3, a4]; b_keys = [b1, b2, b3, b4]
    c_keys = [c1, c2, c3, c4]; d_keys = [d1, d2, d3, d4]
    potential_keys = {a_keys: [a1, a2, a3, a4],
                      b_keys: [b1, b2, b3, b4],
                      c_keys: [c1, c2, c3, c4],
                      d_keys: [d1, d2, d3, d4]}
